const API_BASE = "/api";
const ZENIX_BUILD_VERSION = "20260321-c413";
...
const CATALOG_MIN_VISIBLE_APPEND = 36;
const CATALOG_VISIBLE_APPEND_BATCH_PAGES = 1;
const CATALOG_VISIBLE_APPEND_MAX_STEPS_SCROLL = 4;
...
const MOBILE_EAGER_IMAGE_LIMIT = 160;
const MOBILE_HIGH_PRIORITY_IMAGE_LIMIT = 90;
const DESKTOP_EAGER_IMAGE_LIMIT = 210;
const DESKTOP_HIGH_PRIORITY_IMAGE_LIMIT = 100;
const CRITICAL_COVER_PRIME_MOBILE = 220;
const CRITICAL_COVER_PRIME_DESKTOP = 200;
...
const SCROLL_SYNC_MIN_INTERVAL_MS = 300;
...
const SOURCE_FAILURE_MODE_MS = 90 * 1000;
...
const GLOBAL_REPAIR_STATUS_POLL_MS = 45000;
const GLOBAL_REPAIR_REFRESH_COOLDOWN_MS = 60000;
const AUTO_GLOBAL_REPAIR_WINDOW_MS = 3 * 60 * 1000;
const AUTO_GLOBAL_REPAIR_THRESHOLD = 8;
const AUTO_GLOBAL_REPAIR_COOLDOWN_MS = 90 * 1000;
...
const refs = {
  ...
  adblockGate: document.getElementById("accessLayer"),
  adblockRetryBtn: document.getElementById("accessRetryBtn"),
  adblockGateStatus: document.getElementById("accessStatus"),
...
function buildPlayableSourceCandidates(source, options = {}) {
  ...
  const hostProxyHint =
    !avoidProxyHost &&
    /purstream|xalaflix|fsvid|fsvideo|dood|uqload|uptostream|vidoza|netu|sibnet/i.test(targetHost);
  const proxyPreferred = Boolean(source?.proxyPreferred || hostProxyHint);
